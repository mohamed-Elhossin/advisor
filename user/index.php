...
<main id="main">
      ...
      <div class="row g-5">
        ...
        <div class="col-md-6 col-lg-4 wow bounceInUp">
          <div class="box">
            ...
            <h4 class="title"><a>Provide local Sales</a></h4>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            ...
            <h4 class="title">
              <a>Provide a Lorem ipsum dolor sit.
              </a>
            </h4>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            ...
            <h4 class="title"><a>Provide Lorem, ipsum dolor.
              </a></h4>
  ...
  <section id="why-us" class="why-us">
    <div class="container">
      ...
      <header class="section-header">
        <h3>Why choose us?</h3>
        <p>You can dolor sit amet, consectetur adipisicing elit. Maxime!</p>
      </header>
